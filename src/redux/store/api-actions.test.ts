...
import { NameSpace, AuthorizationStatus, APIRoute } from '../../consts';
...
describe('Async actions', () => {
  ...
  //   it('should dispatch "loginAction.pending" and "loginAction.fullfield" with thunk "loginAction"',async () => {
  //     const fakeUser:AuthData = { login: 'test@test.com', password: 'password' };
